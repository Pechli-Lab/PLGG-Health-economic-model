...
ggsurvplot(
  ...
  title      = "Kaplan-Meier survival curve for PFS, Control arm",
  subtitle   = "Source: SickKids (first-line)"
)
```
...
save(fitted_PFS_chemo, file="fitted_PFS_control_sk_firstline_exp_100.RData")
```
