...
```{r}
fileloc <- here::here("04_analysis","output","scenarios","sickkids control lnorm lifetime combo")
index <- c(1:50)
```
...
df_AE0 <- rbind(df_AE_Targeted, df_AE_SoC)
df_AE <- as.data.frame(apply(df_AE0, 2, cumsum))
df_AE$cycle <- df_AE0$cycle
df_AE$intervention <- df_AE0$intervention
