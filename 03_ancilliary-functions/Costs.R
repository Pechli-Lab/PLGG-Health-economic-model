...
gen_costs <- function(disct){
  ...
  inflat <- 160.9/133.4 # StatsCan CPI 2024 vs. 2018
  discount <- disct # x% discount, e.g. 20% discount = 0.2
  ...
  Costs_trt.l = list(Targeted = 4227.34 * (1-discount), # debraf
                     tram = 173 * 28   * (1-discount)) # monthly
